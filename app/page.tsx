...
export default function Home() {
  return (
    <div className="relative h-screen">
      <PusherConnection/>
      <div className="w-full h-28" style={{ backgroundColor: "#009b4c" }}>
      ...
      <div className="w-full">
        <Grid container spacing={2}>
          <Grid item xs={12} md={6} className="relative">
            <div className="absolute w-2/5 h-44 right-4 top-4 mt-2 bg-white p-2 border-2 rounded-xl border-green-400">
            ...
            <div className="mx-4 my-4 h-40 border-2 rounded-xl border-green-400"></div>
          </Grid>
          <Grid item xs={12} md={6} className="relative">
            <div className="absolute w-2/5 h-44 right-4 top-4 mt-2 bg-white p-2 border-2 rounded-xl border-green-400">
              <Grid container spacing={1}>
